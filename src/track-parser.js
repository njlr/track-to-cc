...
export default function (strParse) {
  ...
  let sTrackData = this.input_trackdata_str;     //--- Get the track data
  ...
  if (bTrack2) {
      ...
      let sYear       = strParse.substr(nSeperator+1,2);
      let sMonth      = strParse.substr(nSeperator+3,2);
